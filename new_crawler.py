...
# getting the standard list of interest
...
age_category=['adolescence','early_adulthood','adulthood','maturity' ]
...
def valer(nan_lst,age,ctr,ptype,gender,interest,cookies,act,token):
    ...
    try:
        ...
        print('\n',age,ctr,ptype,gender)
        # print(json.loads(requests.post(url,header).content))
        nan_lst.append([age,ctr,ptype,gender])
        return np.nan
